...
//                    Toast.makeText(getApplicationContext(),"NOT CREATED",Toast.LENGTH_LONG).show();
                    DocumentReference documentReference = fstore.collection("Good owner").document();
...
//                    startActivity(new Intent(getApplicationContext(),Consumer_sign_in.class));
//                    finish();
