...
//        final StorageReference fileRef = storageReference.child("drivers/"+firebaseAuth.getCurrentUser().getUid()+"profile_pic").child(contentUri.getLastPathSegment());
        final  StorageReference fileRef = storageReference.child("Goods/"+firebaseAuth.getCurrentUser().getUid()+"profile_pic");
...
//                        Toast.makeText(driver_Profile.this, "Successfully updated", Toast.LENGTH_SHORT).show();
            ...
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(getContext(), "Pic not uploaded", Toast.LENGTH_LONG).show();
            }
        });
    ...
    private String getFileExt(Uri contentUri) {
        Context contentResolver = getContext();
        MimeTypeMap mime = MimeTypeMap.getSingleton();
        return mime.getExtensionFromMimeType(String.valueOf(contentResolver.getFileStreamPath(String.valueOf(contentUri))));
    }
