...
public class Mpesa_Test extends AppCompatActivity implements AuthListener, MpesaListener {
    ...
    public static final String CONSUMER_KEY = "EXvAiaPIofJG2SLwcNXd0y9TqcyAp6lr";
    public static final String CONSUMER_SECRET = "3lX8TIAXzCUurwip";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pay = (Button)findViewById(R.id.payy);
    ...
    private void showDialog(String title, String message,int code){
        MaterialDialog dialog = new MaterialDialog.Builder(this)
                ...
                .positiveText("OK")
                .cancelable(false)
                .widgetColorRes(R.color.teal_700)
